...
- Список команд:
    ...
    3.  /images raw - вызов списка id "сырых" изображений
    4.  /images encoded - вызов списка id закодированных изображений
    5.  /get\_image <id>.r - получение "сырого" изображения по id из соответствующего списка
    6.  /get\_image <id>.e - получение закодированного изображения по id из соответствующего списка
    7.  /delete\_image <id> - удаление изображения по его id
    9.  /command_encode_image <id> <текст> - кодирование указанного текста в изображение
        (первый пробел после id указывает на начало текста)
    10. /decode (вместе с картинкой) - декодирование текста из отправляемого изображения
    11. /decode <id> - декодирование текста по id изображения (из списка изображений)
